...
const ActionButton = ({ icon: Icon, label, primary = false, onClick }: { icon?: any, label?: string, primary?: boolean, onClick?: () => void }) => (
    <button
        onClick={onClick}
        className={cn(
            "flex items-center justify-center px-4 py-2 gap-2 rounded-lg border transition-colors shadow-button",
            primary
...
const StatItem = ({ label, value }: { label: string, value: string | number }) => (
    <div className="flex flex-col items-center py-0 gap-[8px] h-[36px] flex-1">
        ...
        <span className="h-[16px] font-sans text-body-sm text-center text-text-primary self-stretch flex-none">{value}</span>
    </div>
);
    ...
    return (
        <PageContainer>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-[12px]">
                    ...
                    <div className="flex items-center gap-[12px] h-[62px]">
                        ...
                        <img
                            src={creator.avatar}
                            alt={creator.name}
                            className="w-[62px] h-[62px] rounded-full object-cover border border-border-primary"
                        />
                        ...
                        <div className="flex items-center gap-[8px]">
                            <button
                                ...
                                className="box-border flex flex-row justify-center items-center py-[14px] px-[16px] gap-[4px] w-[113px] h-[32px] bg-white border border-border-primary rounded-[9px] shadow-button-inset hover:bg-gray-50 transition-colors"
                            >
                                ...
                                <span
                                    className="w-[65px] h-[16px] font-sans text-body-sm flex items-center text-center text-[#353A44] flex-none whitespace-nowrap"
                            ...
                            <div className="relative" ref={actionMenuRef}>
                                <button
                                    ...
                                    className="flex items-center justify-center w-[32px] h-[32px] bg-white border border-border-primary rounded-[9px] shadow-button-inset hover:bg-gray-50 transition-colors"
                                >
                    ...
                    <div className="flex items-center gap-[6px] h-[28px]">
                        <div className="flex flex-row justify-center items-center py-[6px] px-[10px] gap-[4px] w-[84px] h-[28px] bg-surface-secondary rounded-full flex-none">
                            ...
                            <span className="w-[44px] h-[16px] font-sans text-body-sm-regular text-text-primary flex-none whitespace-nowrap">Verified</span>
                        </div>
                        <div className="flex flex-row justify-center items-center py-[6px] px-[10px] gap-[4px] w-[135px] h-[28px] bg-surface-secondary rounded-full flex-none">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-none">
                            ...
                            <span className="w-[95px] h-[16px] font-sans text-body-sm-regular text-text-primary flex-none whitespace-nowrap">{creator.location || 'Toronto, Canada'}</span>
                        </div>
                        <div className="flex flex-row justify-center items-center py-[6px] px-[10px] gap-[4px] w-[83px] h-[28px] bg-surface-secondary rounded-full flex-none">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-none">
                            ...
                            <span className="w-[43px] h-[16px] font-sans text-body-sm-regular text-text-primary flex-none whitespace-nowrap">3 years</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Stats Row */}
                <div className="box-border flex flex-row items-start p-[16px] w-full h-[68px] bg-surface-secondary border border-border-primary rounded-[8px] flex-none z-[2] mt-[12px]">
                    <StatItem label="Revenue" value={creator.revenue} />
                    <div className="w-0 h-[36px] border border-border-primary self-stretch flex-none" />
                        ...
                        <div className="flex flex-col lg:flex-row items-stretch gap-[16px] h-[309px]">
                            ...
                            <div className="flex flex-col gap-[8px] w-full lg:flex-1">
                                <div className="flex items-center gap-[10px] h-[30px] w-full">
                                    <h3 className="h-[19px] font-sans text-heading-sm text-text-primary flex-1 order-0">Revenue</h3>
