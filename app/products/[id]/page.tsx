...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-white">
      {/* Main Content */}
      <div className="flex flex-col px-16 py-6 gap-8">
        {/* Go Back Button */}
        <button
          onClick={() => router.back()}
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3.5">
                <h2 className="font-['Neue_Montreal'] font-bold text-[16px] leading-[19px] text-[#1F1F1F]">
                  {activeLesson.type === 'Reading' ? 'Introduction to Interior Design' : 'Approaching Interior Design'}
                </h2>
                <p className="font-['Neue_Montreal'] font-normal text-[13.5px] leading-[16px] text-[#4B4B4B]">
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col gap-1.5">
                        <div className="flex items-center justify-between">
                          <span className={`font-['Neue_Montreal'] text-[13.5px] leading-[16px] text-[#1F1F1F] ${comment.isCreator ? 'font-bold' : 'font-medium'}`}>
                            {comment.author}
                          </span>
                  ...
                  {expandedModule === module.id && module.lessons.length > 0 && (
                    <div className="flex flex-col gap-1 pt-3">
                      {module.lessons.map((lesson) => (
                        <button
                          key={lesson.id}
                          onClick={() => setActiveLesson({ id: lesson.id, type: lesson.type })}
                        ...
                        >
                          ...
                          <div className="flex-1 flex flex-col gap-0.5">
                            <span className={`font-['Neue_Montreal'] font-medium text-[14px] leading-[17px] ${lesson.active ? 'text-[#5F2EFC]' : 'text-[#2B2834]'}`}>
                              {lesson.title}
                            </span>
