                ...
                <div className="flex-1 overflow-y-auto no-scrollbar">
                    ...
                    <div className="px-6 py-6 flex flex-col gap-3">
                        ...
                        <div className="flex items-center gap-1.5">
                            <div className="flex items-center justify-center gap-1 px-2.5 py-1.5 bg-[#F9F9FB] rounded-full">
                                ...
                                <span className="font-['Neue_Montreal'] font-normal text-[13.5px] leading-[16px] text-[#2B2834]">
                        ...
                        {/* Stats Row */}
                        <div className="flex items-center p-4 bg-[#F9F9FB] border border-[#EBEBEB] rounded-lg h-[68px]">
                            <div className="flex-1 flex flex-col items-center gap-2">
                                <span className="font-['Neue_Montreal'] font-medium text-[10px] leading-[12px] text-center text-[#A5A1AF]">
                                    Revenue Generated
                                </span>
                                <span className="font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-center text-[#2B2834]">
                                    ₦24,567,890
                                </span>
                            </div>
                    ...
                    {/* Tab Content */}
                    {activeTab === 'Overview' && (
                        <div className="px-6 py-6 bg-[#F9F9FB] flex flex-col gap-6">
                            {/* Activity Snapshot */}
                            <div className="flex flex-col gap-2">
                                <h4 className="font-['Neue_Montreal'] font-medium text-[14px] leading-[17px] tracking-[-0.01em] text-[#2B2834]">
                                    Activity Snapshot (last 7 days)
                                </h4>
                                <div className="flex flex-col p-1 bg-[#F9F9FB] rounded-xl">
                                    {/* Table Header */}
                                    <div className="flex items-center px-4 py-2 gap-6">
                                        <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Date</div>
                                        <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Posts</div>
                                        <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Reactions</div>
                                        <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">New Members</div>
                                    </div>
                                        ...
                                        {mockActivityData.map((row, index) => (
                                            <div
                                                ...
                                                className={cn(
                                                    ...
                                                    index !== mockActivityData.length - 1 && "border-b border-[#EBEBEB]"
                                                )}
                                            >
                                                <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">{row.date}</div>
                                                <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">{row.posts}</div>
                                                <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">{row.reactions}</div>
                                                <div className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">{row.newMembers}</div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col p-4 gap-2 bg-white rounded-xl">
                                    <div className="flex gap-4 h-[189px]">
                                        ...
                                        <div className="flex flex-col justify-between items-end w-[21px]">
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-[#A5A1AF]">350</span>
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-[#A5A1AF]">0</span>
                                        </div>
                                    ...
                                    <div className="flex justify-between pl-10">
                                        <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-center text-[#A5A1AF]">1</span>
                                        <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-center text-[#A5A1AF]">14</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {activeTab === 'Members' && (
                        <div className="px-6 py-6 bg-[#F9F9FB] flex flex-col gap-3">
                            <h4 className="font-['Neue_Montreal'] font-medium text-[14px] leading-[17px] tracking-[-0.01em] text-[#2B2834]">
                                Member List
                            </h4>
                                ...
                                {mockMembers.map((member, index) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            index !== mockMembers.length - 1 && "border-b border-[#EBEBEB]"
                                        )}
                                    >
                                        <img
                                            src={member.avatar}
