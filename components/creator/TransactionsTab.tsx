            ...
            <div className="flex flex-col w-full bg-[#F9F9FB] rounded-b-[36px] p-6 gap-6">
                <div className="flex flex-col p-1 gap-1 bg-[#F9F9FB] rounded-xl">
                    ...
                    <div className="flex items-center px-4 py-2 gap-4 w-full">
                        <span className="w-[12%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Timestamp</span>
                        <span className="w-[16%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Buyer</span>
                        <span className="w-[24%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Product/Activity</span>
                        ...
                        <span className="w-[12%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Method</span>
                        <span className="w-[10%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Status</span>
                    ...
                    <div className="bg-white border border-[#EBEBEB] rounded-lg">
                        {mockTransactions.map((transaction, index) => (
                            ...
                            >
                                ...
                                <span className="w-[16%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834] truncate">
                                    {transaction.buyer}
                                </span>
                                <span className="w-[24%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834] truncate">
                                    {transaction.product}
                                </span>
                                <span className="w-[12%] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834] truncate">
                                    {transaction.amount}
