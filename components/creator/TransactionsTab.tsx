                    ...
                    <DataTableShell>
                        <div className="min-w-[920px]">
                            <div className="flex w-full items-center gap-4 px-4 py-2">
                                <span className="basis-[12%] font-sans text-body-sm text-text-secondary">Timestamp</span>
                                <span className="basis-[16%] font-sans text-body-sm text-text-secondary">Buyer</span>
                                <span className="basis-[24%] font-sans text-body-sm text-text-secondary">Product/Activity</span>
                                <span className="basis-[12%] font-sans text-body-sm text-text-secondary">Amount</span>
                                <span className="basis-[10%] font-sans text-body-sm text-text-secondary">Fee</span>
                                <span className="basis-[12%] font-sans text-body-sm text-text-secondary">Method</span>
                                <span className="basis-[10%] font-sans text-body-sm text-text-secondary">Status</span>
                                <div className="basis-[4%] opacity-0">
                            ...
                            <div className="rounded-lg border border-border-primary bg-white">
                                {mockTransactions.map((transaction, index) => (
                                    <div
                                        ...
                                        className={cn(
                                            "flex w-full cursor-pointer items-center gap-4 bg-white px-4 py-3 transition-colors hover:bg-gray-50",
                                            index !== mockTransactions.length - 1 && "border-b border-border-primary"
                                        )}
                                    >
                                        <span className="basis-[12%] truncate font-sans text-body-sm text-text-primary">
                                            {transaction.timestamp}
                                        </span>
                                        <span className="basis-[16%] truncate font-sans text-body-sm text-text-primary">
                                            {transaction.buyer}
                                        </span>
                                        <span className="basis-[24%] truncate font-sans text-body-sm text-text-primary">
                                            {transaction.product}
                                        </span>
                                        <span className="basis-[12%] truncate font-sans text-body-sm text-text-primary">
                                            {transaction.amount}
                                        </span>
                                        <span className="basis-[10%] truncate font-sans text-body-sm text-text-primary">
                                            {transaction.fee}
                                        </span>
                                        <span className="basis-[12%] truncate font-sans text-body-sm text-text-primary">
                                            {transaction.method}
                                        ...
                                        <button
                                            className="flex h-[18px] basis-[4%] items-center justify-center"
                                            onClick={(e) => {
