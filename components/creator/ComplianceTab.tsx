    ...
    return (
        <div className="flex flex-col w-full bg-[#F9F9FB] rounded-b-[36px] p-6 gap-6">
            <div className="flex flex-col gap-2">
                {/* Toggle Tabs */}
                <div className="flex items-center p-1 gap-[3px] w-[295px] bg-[#F9F9FB] border border-[#EBEBEB] rounded-lg">
                    <button
                        onClick={() => setActiveTab('Verification')}
                        className={cn(
                            "flex items-center justify-center px-4 py-[7px] rounded-md font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] transition-all w-[99px] h-[30px]",
                            activeTab === 'Verification'
                                ? "bg-white text-[#2B2834] shadow-[0px_0px_4px_rgba(0,0,0,0.18)]"
                                : "bg-[#F9F9FB] text-[#A5A1AF]"
                        )}
                    >
                        Verification
                    </button>
                    <button
                        ...
                        className={cn(
                            "flex items-center justify-center px-4 py-[7px] rounded-md font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] transition-all w-[103px] h-[30px]",
                    ...
                    <button
                        ...
                        className={cn(
                            "flex items-center justify-center px-4 py-[7px] rounded-md font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] transition-all w-[79px] h-[30px]",
                            activeTab === 'Reports'
                                ? "bg-white text-[#2B2834] shadow-[0px_0px_4px_rgba(0,0,0,0.18)]"
                                : "bg-[#F9F9FB] text-[#A5A1AF]"
                        )}
                ...
                {activeTab === 'Verification' && (
                    <div className="flex flex-col p-1 gap-1 rounded-xl">
                        ...
                        <div className="flex flex-col p-4 gap-4 bg-white border border-[#EBEBEB] rounded-lg">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {personalInfo.map((info, index) => (
                                    <div
                                        key={index}
                                        className="flex flex-col justify-center p-4 gap-[6px] w-[259px] bg-[#F9F9FB] border border-[#EBEBEB] rounded-lg"
                                    >
                                        <div className="flex items-center justify-between gap-1">
                                            <span className="font-['Neue_Montreal'] font-normal text-[13px] leading-[16px] text-[#5F5971]">
                                                {info.label}
                                            </span>
                                            {info.status === 'verified' ? (
                                                <div className="flex items-center justify-center gap-0.5 px-[6px] py-[2px] pl-[3px] bg-[#E7F3EF] rounded h-[16px]">
                                                ...
                                                <div className="flex items-center justify-center gap-0.5 px-[6px] py-[2px] pl-[3px] bg-[#FFF3EB] rounded h-[16px]">
                                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span className="font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">
                                            {info.value}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="flex flex-col p-4 gap-4 bg-white border border-[#EBEBEB] rounded-lg">
                            ...
                            <div className="flex items-center gap-2">
                                {documents.map((doc, index) => (
                                    <div
                                        key={index}
                                        className="flex flex-col w-[210px] min-w-[200px] border border-[#F0EBF4] rounded-lg overflow-hidden"
                                    >
                                        {/* Document Preview */}
                                        <div
                                        ...
                                        {/* Document Info */}
                                        <div className="flex items-center p-3 gap-2 bg-white border-t border-[#F0EBF4]">
                                            ...
                                            <div className="flex flex-col flex-1">
                                                <span className="font-['Neue_Montreal'] font-medium text-[13px] leading-[16px] text-[#17181C]">
                                                    {doc.name}
                                                </span>
                                                <div className="flex items-center gap-1">
                                                    <span className="font-['Neue_Montreal'] font-normal text-[10px] leading-[12px] text-[#999999]">
                                                        {doc.type}
                                                    </span>
                ...
                {activeTab === 'Restrictions' && (
                    <div className="flex flex-col px-4 py-[6px] gap-4 bg-white border border-[#EBEBEB] rounded-lg">
                        {restrictionStates.map((restriction, index) => (
                            <div
                                key={index}
                                className={cn(
                                    "flex items-center justify-center py-3 gap-6",
                                    index !== restrictionStates.length - 1 && "border-b border-[#EBEBEB]"
                                )}
                            >
                                <span className="flex-1 font-['Neue_Montreal'] font-medium text-[14px] leading-[17px] text-[#2B2834]">
                                    {restriction.label}
                                </span>
                                <button
                                    onClick={() => {
                                ...
                                >
                                    <div className="w-4 h-4 bg-white rounded-full shadow-[0px_3px_8px_rgba(0,0,0,0.15),0px_3px_1px_rgba(0,0,0,0.06)]" />
                                </button>
                            </div>
                        ))}
                    </div>
                ...
                {activeTab === 'Reports' && (
                    <div className="flex gap-2">
                        {/* Reports Table */}
                        <div className="flex-1 flex flex-col p-1 gap-1 bg-[#F9F9FB] rounded-xl">
                            {/* Table Header */}
                            <div className="flex items-center px-4 py-2 gap-4">
                                <span className="w-[85px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Date</span>
                                <span className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Reporter</span>
                                <span className="w-[72px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Type</span>
                                <span className="w-[169px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Reason</span>
                                <span className="w-[76px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Status</span>
                                <span className="w-[78px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#5F5971]">Action Taken</span>
                            </div>
                                ...
                                {reports.map((report, index) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            index !== reports.length - 1 && "border-b border-[#EBEBEB]"
                                        )}
                                    >
                                        <span className="w-[85px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">
                                            {report.date}
                                        </span>
                                        <span className="flex-1 font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">
                                            {report.reporter}
                                        </span>
                                        <span className="w-[72px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">
                                            {report.type}
                                        </span>
                                        <span className="w-[169px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">
                                            {report.reason}
                                        </span>
                                        ...
                                        <span className="w-[78px] font-['Neue_Montreal'] font-medium text-[13.5px] leading-[16px] text-[#2B2834]">
                                            {report.action}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="flex flex-col p-1 gap-1 w-[256px]">
                            <h3 className="font-['Neue_Montreal'] font-medium text-[16px] leading-[19px] text-[#2B2834] py-2">
                                Report Trends
                            </h3>
                            <div className="flex flex-col items-center p-6 gap-4 bg-white border border-[#EBEBEB] rounded-lg flex-1 justify-center">
                                {/* Pie Chart */}
                                ...
                                <div className="flex flex-col gap-3 w-full">
                                    <div className="flex items-center gap-1">
                                        ...
                                        <div className="flex items-center gap-[5px]">
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black">Spam</span>
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black/40">50%</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        <div className="w-3 h-3 bg-[#9DAAFF] rounded" />
                                        <div className="flex items-center gap-[5px]">
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black">Profanity</span>
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black/40">30%</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        <div className="w-3 h-3 bg-[#9AC3FF] rounded" />
                                        <div className="flex items-center gap-[5px]">
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black">Harassment</span>
                                            <span className="font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black/40">20%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
