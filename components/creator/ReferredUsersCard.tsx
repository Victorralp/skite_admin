    ...
    return (
        <div className="flex flex-col gap-[8px] w-full">
            <div className="flex items-center gap-[10px] h-[30px] w-full">
                <h3 className="w-[267px] h-[19px] font-['Neue_Montreal'] font-medium text-[16px] leading-[19px] text-[#2B2834] flex-none order-0 grow">Referred Users</h3>
                <CustomDropdown options={['All Time', 'This Year', 'This Month']} defaultLabel="All Time" width="78px" menuWidth="100px" />
            </div>

            <div className="box-border flex flex-col justify-center items-center p-[24px] gap-[12px] w-[355px] h-[271px] bg-white border border-[#EBEBEB] rounded-[12px] flex-none order-1 self-stretch grow z-0 relative">
                <div className="w-[197px] h-[197px] flex-none order-0 grow relative">
                    ...
                    <div className="absolute left-1/2 top-[69px] -translate-x-1/2 flex flex-col items-center p-0 w-[84.18px] h-[36px]">
                        <span className="w-[84.18px] h-[22px] font-['Neue_Montreal'] font-bold text-[18px] leading-[22px] text-center text-[#2B2834] flex-none order-0 self-stretch grow-0">1,248</span>
                        <span className="w-[84.18px] h-[14px] font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-center text-[rgba(0,0,0,0.4)] flex-none order-1 self-stretch grow-0">Users</span>
                    </div>
                </div>
                ...
                <div className="flex flex-row items-end p-0 gap-[22px] w-[185px] h-[14px] flex-none order-1 grow-0">
                    <div className="flex flex-row items-center p-0 gap-[4px] w-[76px] h-[14px] flex-none order-0 grow-0">
                        ...
                        <div className="flex flex-row items-center p-0 gap-[5px] w-[60px] h-[14px] flex-none order-1 grow-0">
                            <span className="w-[31px] h-[14px] font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black flex items-center flex-none order-0 grow-0">Users</span>
                            <span className="w-[24px] h-[14px] font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-[rgba(0,0,0,0.4)] flex-none order-1 grow-0">86%</span>
                        </div>
                    </div>
                    <div className="flex flex-row items-center p-0 gap-[4px] w-[87px] h-[14px] flex-none order-1 grow-0">
                        ...
                        <div className="flex flex-row items-center p-0 gap-[5px] w-[71px] h-[14px] flex-none order-1 grow-0">
                            <span className="w-[45px] h-[14px] font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-black flex items-center flex-none order-0 grow-0">Creators</span>
                            <span className="w-[21px] h-[14px] font-['Neue_Montreal'] font-normal text-[12px] leading-[14px] text-[rgba(0,0,0,0.4)] flex-none order-1 grow-0">14%</span>
                        </div>
                    </div>
                </div>
            </div>
