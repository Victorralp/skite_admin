...
const RatingDistribution = ({ 
  ...
  return (
    <div className={`flex flex-col justify-center items-start px-[105px] py-4 gap-0.5 w-[348.67px] h-[100px] border-r border-[#EBEBEB] ${className}`}>
      {data.map((item) => (
        <div key={item.stars} className="flex items-center gap-[5px] h-3">
          {/* Star + Number Frame */}
