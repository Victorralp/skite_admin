    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-end p-6 gap-6 overflow-y-auto">
          ...
          <div className="flex items-center px-4 py-6 gap-3 w-full bg-white border border-border-primary rounded-lg">
            {/* Product Icon */}
            <div className="flex items-center justify-center w-[38px] h-[38px] bg-black border border-border-primary rounded-lg flex-shrink-0">
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              <div className="flex items-center gap-1">
                <span className="font-sans font-normal text-base leading-[19px] text-text-secondary">
                  Purchase of
                </span>
                <span className="font-sans font-medium text-base leading-[19px] text-text-primary">
                  {transaction.product}
                </span>
              </div>
              <div className="flex items-center gap-0.5 px-1.5 py-0.5 bg-surface-success rounded w-fit">
                ...
                <span className="font-sans font-medium text-xs leading-none text-text-success">
                  Success
                </span>
              </div>
            </div>
            ...
            {/* Amount */}
            <span className="font-sans font-bold text-base leading-[19px] text-text-primary">
              {transaction.amount}
            </span>
          </div>
          ...
          <div className="flex flex-col items-start gap-4 w-full">
            <h3 className="font-sans font-medium text-lg leading-[22px] text-text-primary">
              Details
            </h3>
            ...
            <div className="flex flex-col justify-center items-start gap-4 w-full bg-white rounded">
              ...
              <div className="flex justify-end items-center w-full h-4">
                <span className="flex-1 font-sans text-body-sm-regular text-text-secondary">
                  Transaction ID
                </span>
                <div className="flex-1 flex justify-center items-center gap-1.5">
                  <span className="flex-1 font-sans text-body-sm text-right text-text-primary">
                    {transaction.id}
                  </span>
                  <button onClick={handleCopyId} className="flex-shrink-0">
                    <Copy size={16} className="text-text-brand" />
                  </button>
                </div>
              </div>
              ...
              <div className="flex justify-end items-center w-full h-4">
                ...
                <div className="flex-1 flex justify-center items-center gap-1">
                  <span className="flex-1 font-sans text-body-sm text-right underline text-text-primary cursor-pointer">
                    {transaction.creator}
                  </span>
